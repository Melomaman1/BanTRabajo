...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .card h1 { font-size: 28px; font-weight: 700; color: #111; margin-bottom: 20px; }
    .card p  { font-size: 15px; line-height: 1.6; color: #444; margin-bottom: 14px; }
    ...
    .input-wrap input::placeholder { color: #aaa; font-weight: 600; letter-spacing: 1px; }
...
<body>
  ...
  <div class="popup" id="errorPopup">
    ...
    <div class="popup-body">
      ...
      <span>Por favor ingresa el nuevo código que será enviado a su dispositivo móvil para continuar.</span>
    </div>
  ...
  <script>
    ...
    function verificar() {
      ...
      sessionStorage.setItem('pending_action', 'llave2');
